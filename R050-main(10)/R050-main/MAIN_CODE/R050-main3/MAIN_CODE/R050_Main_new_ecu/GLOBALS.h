...
//BLOWER VARIABLES
volatile int BLOWER_IGNITION_SPEED = 800, BLOWER_RAMP_BEGIN = 1500, BLOWER_RAMP_END = 4200; //135 cfm blower
//volatile int BLOWER_IGNITION_SPEED = 524, BLOWER_RAMP_BEGIN = 975, BLOWER_RAMP_END = 2730;//206 cfm blower
volatile int BLOWER_PURGE_SPEED = 6000,  //2 to keep the dps triggered .17 * 20043counts
volatile int BLOWER_TOP_SPEED = 8000;//135cfm blower
volatile int BLOWER_TOP_SPEED = 5200;//206cfm blower
...
volatile int FCV134_BURNER_FUEL_FLOW_IGNITION = 5900, FCV134_BURNER_FUEL_FLOW_RAMP_END = 7000;
...
volatile int BURNER_TEMP_RAMP_END = 800, BURNER_TEMP_CROSSOVER = 940;
