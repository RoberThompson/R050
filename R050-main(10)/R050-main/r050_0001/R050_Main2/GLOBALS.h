...
volatile long STEAM_GENERATION_TIMER = 1800000; //30 mins
...
//BLOWER VARIABLES
volatile int BLOWER_PURGE_SPEED = 6000, BLOWER_IGNITION_SPEED = 800, BLOWER_RAMP_BEGIN = 1000, BLOWER_RAMP_END = 3600; //2 to keep the dps triggered .17 * 20043counts
volatile int BLOWER_TOP_SPEED = 6400;
...
volatile int RO_PUMP_TOP_SPEED = 5000; //counts//3000
...
volatile int FCV134_BURNER_FUEL_FLOW_IGNITION = 5900, FCV134_BURNER_FUEL_FLOW_RAMP_END = 9400; //5 volts ~40 percent open
volatile int FCV134_BURNER_FUEL_FLOW_RAMP_BEGIN = 7500;
...
volatile int BURNER_TEMP_RAMP_END = 800, BURNER_TEMP_CROSSOVER = 880;
...
float SR_FUEL_CUT = 0.5; //grams per second
...
uint16_t cmdSpeedBlower = 0, cmdSpeedWp = 0, cmdPercentFcv134 = 0, cmdPercentFcv205 = 0, cmdPercentFcv141 = 0;
bool cmdXv801=0, cmdBlwrEn=0, cmdWpEn=0, cmdTwv308=0, cmdXv1100=0, cmdXv501=0, cmdBmmCr2=0, cmdTwv901=0, cmdXv909=0;
