void OTFOverrides() {
  ...
  if (xv801Override) {
    ...
    modbusTCPClient7.coilWrite(5, cmdXv801); //XV801
  }
  ...
  if (blwrEnOverride) {
    ...
    modbusTCPClient7.coilWrite(9, cmdBlwrEn); //XV801
  }
  ...
  if (wpEnOverride) {
    ...
    modbusTCPClient7.coilWrite(10, cmdWpEn); //XV801
  }
  ...
  if (twv308Override) {
    ...
    modbusTCPClient7.coilWrite(6, cmdTwv308); //twv308
  }
  ...
  if (xv1100Override) {
    ...
    modbusTCPClient7.coilWrite(4, cmdXv1100); //XV1100
  }
  ...
  if (xv501Override) {
    ...
    modbusTCPClient7.coilWrite(3, cmdXv501); //XV501
  }
  ...
  if (bmmCr2Override) {
    ...
    modbusTCPClient7.coilWrite(8, cmdBmmCr2); //XV501
  }
  ...
  if (twv901Override) {
    ...
    modbusTCPClient7.coilWrite(7, cmdTwv901); //XV501
  }
  ...
  if (xv909Override) {
    ...
    modbusTCPClient7.coilWrite(2, cmdXv909); //XV501
  }
...
void SRFuelPID() {
  if (fcv141Override) {
    modbusTCPClient2.holdingRegisterWrite(40, cmdPercentFcv141); //write channel 4 (FCV141)
    Serial.write('_'); Serial.write('!'); Serial.print(F("FT132.FLOW: ")); Serial.println(FT132_NG_FEED_FLOW);
  }
  else {
...
void readAI() {
  ...
  FT132_NG_FEED_FLOW = modbusTCPClient6.inputRegisterRead(2)*4/65535;
  ...
  //txGUI[27] = FT132_NG_FEED_FLOW ;
  Serial.write('_'); Serial.write(myChars[27]); Serial.println(FT132_NG_FEED_FLOW);
  txGUI[34] = FCV134_BURNER_FUEL_FLOW_FB;
